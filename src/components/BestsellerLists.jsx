...
function BestsellerLists() {
        ...
        return (
            <div key={book.id} className="slider-item">
                ...
                <div className="item-info">
                    ...
                    <span id="rating"><img src={star} alt="star"/> 5.0</span>
    ...
    return (
        <div className="bestsellers">
            ...
            <div className="slide">
                <img onClick={() => handleClick('forward', "bestsell-slider")} id="next" src={forward} alt="next" />
                <div className="books-container">
                    <div className="bestsell-slider slide-container">
                        {bookLists}
                    </div>
                </div>
                <img onClick={() => handleClick('back', "bestsell-slider")} id="previous" src={back} alt="previous" />
            </div>
        </div>
    )
}
