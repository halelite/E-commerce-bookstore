...
function NewBookLists() {
    ...
    return (
        <div className="new">
            ...
            <div className="slide">
                <img onClick={() => handleClick('forward', "new-slider")} id="next" src={forward} alt="next" />
                <div className="books-container">
                    <div className="new-slider slide-container">
                        {bookLists}
                    </div>
                </div>
                <img onClick={() => handleClick('back', "new-slider")} id="previous" src={back} alt="previous" />
            </div>
        </div> 
    )
}
