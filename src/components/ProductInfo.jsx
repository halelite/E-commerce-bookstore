        ...
        <div className="product-info"> 
            <div className="product-wrap">
                ...
                <div className="productInfo-wrap">
                    <h2><span>نام کتاب:</span> {book.title}</h2>
                    <h2><span>نام نویسنده:</span> {book.author}</h2>
                    <h2><span>دسته بندی:</span> {book.category}</h2>
                    {book.price && 
                    <h2 className="price">{book.price.toLocaleString()} <span>تومان</span></h2>
                    }
